        ...
        <ul className="d-flex justify-content-evenly flex-wrap m-0 align-items-center">
          <li className="text-center">
            ...
            >
              ...
              <span>Home</span>
             <img
                  src={location.pathname.includes('dashboard') ? menuActive : menuNotActive}
                  alt={location.pathname.includes('dashboard') ? "Active Menu" : "Not Active Menu"}
              />
            </NavLink>
          </li>
          <li className="text-center">
            ...
            >
              ...
              <span>Student</span>
               <img
                  src={location.pathname.includes('students') ? menuActive : menuNotActive}
                  alt={location.pathname.includes('students') ? "Active Menu" : "Not Active Menu"}
                />
            </NavLink>
          </li>
          <li className="text-center">
            ...
            >
              ...
              <span>Fees</span>
               <img
                  src={location.pathname.includes('fees') ? menuActive : menuNotActive}
                  alt={location.pathname.includes('fees') ? "Active Menu" : "Not Active Menu"}
                />
            </NavLink>
          </li>
          <li className="text-center">
            ...
            >
              ...
              <span>Menu</span>
              <img
                  src={location.pathname.includes('menu') ? menuActive : menuNotActive}
                  alt={location.pathname.includes('menu') ? "Active Menu" : "Not Active Menu"}
              />
            </NavLink>
          </li>
        </ul>
